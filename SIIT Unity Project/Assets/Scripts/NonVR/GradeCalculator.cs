...
namespace NonVR
{
    ...
    {
        private readonly int timeForMaxGrade;
        private int secondsPerGradePenalty;

        public GradeCalculator(int maxGradeTime, int gradePenaltyForSeconds)
        {
            timeForMaxGrade = maxGradeTime;
            secondsPerGradePenalty = gradePenaltyForSeconds;
        }
